    ...
    'valid': [
        ...
        },
        {
            'input': {
                ...
                'derivation_path': [LEGACY_PURPOSE, DASH_COIN_INDEX, HARDENED_BASE, 1, 0],
            },
    ...
    'invalid': [
        {
            ...
            'derivation_path': [LEGACY_PURPOSE, 4, HARDENED_BASE, 1, 0],
        },
        {
            'public_key': bytes([
                4, 114, 58, 22, 162, 239, 174, 254, 135, 250, 145, 227, 19, 86, 116,
            ...
            'derivation_path': [LEGACY_PURPOSE, 99, HARDENED_BASE, 1, 0],
        },
        {
            'public_key': bytes([
                4, 114, 58, 22, 162, 239, 174, 254, 135, 250, 145, 227, 19, 86, 116,
            ...
            'derivation_path': [134, 99, HARDENED_BASE, 1, 0],
        },
        {
            'public_key': bytes([]),
            'derivation_path': [LEGACY_PURPOSE, 0, HARDENED_BASE, 1, 0],
        },
    ],
}
