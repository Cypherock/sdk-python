    ...
    "valid": [
        {
            ...
            "packet": bytes([170, 88, 7, 0, 1, 0, 1, 0, 69, 133]),
            "ackPackets": [
                bytes([170, 1, 7, 0, 1, 0, 1, 0, 69, 133]),
                bytes([170, 88, 12, 0, 1, 0, 1, 0, 0, 0, 1, 0, 16, 118, 67]),
            ],
        },
        {
            "output": {"sdkVersion": "0.1.16", "packetVersion": "v1"},
        ...
        },
        {
            ...
            "ackPackets": [
                bytes([170, 1, 7, 0, 1, 0, 1, 0, 69, 133]),
                bytes([170, 88, 12, 0, 1, 0, 1, 0, 1, 0, 17, 0, 6, 237, 134]),
            ],
        },
        {
            "output": {"sdkVersion": "1.17.6", "packetVersion": "v2"},
        ...
        },
        {
            ...
            "ackPackets": [
                bytes([170, 1, 7, 0, 1, 0, 1, 0, 69, 133]),
                bytes([170, 88, 12, 0, 1, 0, 1, 0, 2, 0, 7, 0, 1, 130, 112]),
            ],
        },
        {
        ...
        },
        {
            ...
            "ackPackets": [
                bytes([170, 1, 7, 0, 1, 0, 1, 0, 69, 133]),
                bytes([170, 88, 12, 0, 1, 0, 1, 0, 3, 0, 2, 0, 49, 245, 130]),
            ],
        },
        {
            "output": {"sdkVersion": "3.2.49", "packetVersion": "v3"},
        ...
        {
            "output": {"sdkVersion": "21.49.530", "packetVersion": None},
            "isLegacyOperationSupported": False,
            "isRawOperationSupported": False,
            "isProtoOperationSupported": False,
            "isInBootloader": False,
