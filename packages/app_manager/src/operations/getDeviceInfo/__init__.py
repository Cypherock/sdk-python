...
from packages.app_manager.src.proto.generated.types import IGetDeviceInfoResultResponse
...
async def get_device_info(sdk: ISDK) -> IGetDeviceInfoResultResponse:
    logger.info('Started')
