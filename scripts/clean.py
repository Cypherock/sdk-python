...
common_py_folders = ['__pycache__', '*.egg-info', 'dist', 'build', '.pytest_cache', '.coverage']
...
async def confirm_from_user(question: str, positive_response: List[str], negative_response: List[str]) -> bool:
